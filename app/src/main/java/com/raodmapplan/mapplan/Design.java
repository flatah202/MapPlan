...
public class Design extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if(type.equals("register")) {
                    post_data = URLEncoder.encode("user_name", "UTF-8") + "=" + URLEncoder.encode(name, "UTF-8") + "&"
                            + URLEncoder.encode("password", "UTF-8") + "=" + URLEncoder.encode(username, "UTF-8")+ "&"
                            + URLEncoder.encode("confirm_password", "UTF-8") + "=" + URLEncoder.encode(password, "UTF-8");
                }
